...
export const _appInvoices = [...Array(5)].map((_, index) => ({
  ...
  price: _mock.number.age(index),
  category: randomInArray(['Summer Internship', 'Graduate Programme', 'Off-Cycle Internship']),
  status: randomInArray(['Ongoing', 'out_of_date', 'in_progress']),
}));
